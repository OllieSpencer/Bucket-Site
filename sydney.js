  ...
  window.addEventListener("scroll", function () {
    if (window.scrollY > 200 && !newImageShown) {
      ...
      setTimeout(function () {
        ...
        simpleTypeText(
          "The desert disappeared and was slowly replaced by rolling hills dotted with cattle as we approached the city limits. We cracked an iced coffee can and had a ciggie next to a farm while the train was stopped for a while waiting to enter the metro network. We threw caution to the wind for the last leg of the trip and made no effort hiding. Passengers on platforms spun their heads around as they spotted us fly past them. The train found its way to the Aurizon terminal just outside Campbelltown. A group of Aurizon workers were waiting for us when we arrived, someone had called us in. We hastily made our down the live tracks to an adjacent house, hopped the fence and escaped through someone's backyard. We made our way to Campbelltown station and celebrated with a Fijian pastie. We’d made it, unlike last time, when we ended up in Perth.",
          textElement2
        );
      }, 1000);
    }
